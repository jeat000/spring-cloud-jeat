...
public interface LeaveService {
	...
	public List<String> getHighLightedFlows(BpmnModel bpmnModel,ProcessDefinitionEntity deployedProcessDefinition,List<HistoricActivityInstance> historicActivityInstances);
